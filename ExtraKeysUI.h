...
private:
    static LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
        ...
        if (uMsg == WM_CREATE) {
            ...
            KeyboardRow rows[4] = {
                {"1234567890", 0}, {"QWERTYUIOP", 15}, {"ASDFGHJKL", 25}, {"ZXCVBNM", 45}      
            };
            ...
            SpecialKey specials[] = {
                ...
                { L"Ctrl",  1003, &state.showCtrl }, { L"MB 4",  1004, &state.showMB4 }, { L"MB 5",  1005, &state.showMB5 }
            };
...
public:
    static void Init(HINSTANCE hInstance) {
        ...
        AppState::Get().hwndExtraKeys = CreateWindowExW(0, L"ExtraKeysClass", L"Extra Keys Settings", WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU, 150, 150, 470, 265, NULL, NULL, hInstance, NULL);
    }
